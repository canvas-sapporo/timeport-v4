    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          <Link href={`/admin/request-types/${requestType.id}/edit`}>
            <Button>
                        ...
                        {field.validationRules && Object.keys(field.validationRules).length > 0 ? (
                          <div className="space-y-1">
                            {field.validationRules.minLength && (
                              <div>最小: {field.validationRules.minLength}文字</div>
                            )}
                            {field.validationRules.maxLength && (
                              <div>最大: {field.validationRules.maxLength}文字</div>
                            )}
                            {field.validationRules.pattern && (
                              <div>パターン: {field.validationRules.pattern}</div>
                            )}
